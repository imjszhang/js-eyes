...
window.I18nLocales['en-US'] = {
    ...
    hero: {
        badge: 'v2.10.0 // BROWSER AUTOMATION',
    ...
    skills: {
        ...
        loadFailed: 'Failed to load skill registry. Please refresh and try again.',
        toolsBadge: 'AI TOOLS',
        platformLabel: 'PLATFORM',
        loginBadge: 'LOGIN REQUIRED',
        cookiesBadge: 'BROWSER COOKIES',
        dependsBadge: 'REQUIRES JS-EYES',
        toolsHeader: 'Top tools',
        moreTools: '+{n} more',
        viewHomepage: 'Source',
