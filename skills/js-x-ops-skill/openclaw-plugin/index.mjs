  ...
  api.registerTool(
    {
      ...
      description:
        "搜索 X.com (Twitter) 内容。支持关键词搜索、排序、日期范围、作者过滤、互动数过滤等。返回结构化帖子数据（含作者、内容、统计、媒体）。",
      parameters: {
        type: "object",
        properties: {
          keyword: {
  ...
  api.registerTool(
    {
      ...
      description:
        "浏览 X.com 指定用户的主页与时间线内容。返回用户资料和帖子列表。支持翻页、日期筛选、互动数过滤。",
      parameters: {
        type: "object",
        properties: {
          username: {
  ...
  api.registerTool(
    {
      ...
      description:
        "读取 X.com 帖子的完整详情，包括内容、统计、媒体。可选获取对话线程和回复；也可作为后续回复、引用等发布流程的输入。",
      parameters: {
        type: "object",
        properties: {
          tweetUrl: {
  ...
  api.registerTool(
    {
      ...
      description:
        "浏览 X.com 首页 Feed（For You 或 Following）。返回帖子列表，支持翻页和过滤。",
      parameters: {
        type: "object",
        properties: {
          feed: {
