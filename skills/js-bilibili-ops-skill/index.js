...
const COMMANDS = {
  video: {
    module: './scripts/bilibili-video',
    description: '读取 Bilibili 视频元数据',
  },
  subtitles: {
    module: './scripts/bilibili-subtitles',
    description: '读取 Bilibili 视频字幕',
  },
};

function printUsage() {
  console.log('\njs-bilibili-ops-skill - Bilibili 视频读取工具');
