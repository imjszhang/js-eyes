...
async function runYoutubeOperation(url, options, config) {
...
async function getVideo(url, options = {}) {
  return runYoutubeOperation(url, options, {
    scrapeType: 'youtube_video',
    cacheNamespace: 'video',
    runner: getYoutubeVideoDetails,
  });
}

async function getSubtitles(url, options = {}) {
  return runYoutubeOperation(url, options, {
    scrapeType: 'youtube_subtitles',
    cacheNamespace: 'subtitles',
    runner: getYoutubeSubtitlesResult,
  });
}
