...
1. Download `js-eyes-skill.zip` from [js-eyes.com](https://js-eyes.com/js-eyes-skill.zip), or the versioned `js-eyes-skill-v<version>.zip` asset (e.g. `js-eyes-skill-v2.6.3.zip`) from [GitHub Releases](https://github.com/imjszhang/js-eyes/releases/latest)
...
JS Eyes registers as an [OpenClaw](https://openclaw.ai/) plugin, exposing one `js-eyes` tool that routes browser automation and extension-skill actions.
...
- **1 AI Tool** — `js-eyes`, with path-style actions for browser automation and skill management
