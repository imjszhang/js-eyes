...
// Object.assign(module.exports, ...).
module.exports.applySkillInstall = applySkillInstall;
module.exports.cleanupStaging = cleanupStaging;
module.exports.createSkillTrustStore = createSkillTrustStore;
module.exports.discoverLocalSkills = discoverLocalSkills;
...
module.exports.readSkillById = readSkillById;
module.exports.readSkillByIdFromSources = readSkillByIdFromSources;
module.exports.resolveSkillSources = resolveSkillSources;
module.exports.resolveSkillsDir = resolveSkillsDir;
module.exports.runSkillCli = runSkillCli;
module.exports.skillToolActionName = skillToolActionName;
module.exports.verifySkillIntegrity = verifySkillIntegrity;
