...
function printHelp() {
  ...
  print('  js-eyes browser state --tab-id <id>');
  print('  js-eyes browser resume <pendingId>');
  print('  js-eyes browser downloads');
  print('  js-eyes secrets list|set <name> [--value <text>]|delete <name>');
